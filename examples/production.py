...
equil_dir = f"{project_dir}/equilibration/{system_name}/{ligand_name}/repeat_{repeat}/"
...
production_dir = os.path.join(project_dir, "outputs", system_name, f"{ligand_name}", f"repeat_{repeat}")
