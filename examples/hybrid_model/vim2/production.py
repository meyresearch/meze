...
with open(f"{project_dir}/inputs/hybrid_model/protein/vim2/model_ezaff_recipe.json", "r") as file:
...
production_dir = os.path.join(project_dir,
                              "outputs",
                              f"{ligand_name}",
                              f"repeat_{repeat}")
os.makedirs(production_dir, exist_ok=True)

hot_meze.run(process_name="prod",
